...
# Define a global alias for the floating-point type
const FloatType = Ref{DataType}(Float32) # Default to Float32

export set_global_precision, FloatType
...
include("solvers/rotated-box.jl")
...
include("propagate/operators/pooling.jl")
include("propagate/operators/slice.jl")
include("propagate/operators/flatten.jl")
...
include("propagate/operators/parallel.jl")
...
export Ai2, Ai2h, Ai2z, Box, ExactReach, RotatedBox
export StarSet
export ImageStar, ImageZono
export IBP, Crown, BetaCrown
