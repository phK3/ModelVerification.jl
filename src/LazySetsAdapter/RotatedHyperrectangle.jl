...
module LazySetsAdapter

using LazySets
import LazySets: isoperationtype, dim, ρ, center, generators, genmat, linear_map, vertices_list, constraints_list, generators_fallback
import LazySets: _ρ_linear_map, _σ_linear_map, generators
